...
public class MailSender {
    ...
    public void send() throws Exception
    {
        ...
        //此处填写SMTP服务器
        props.put("mail.smtp.host", env.getProperty("mail.smtp.service"));
        //设置端口号，QQ邮箱给出了两个端口465/587
        props.put("mail.smtp.port", env.getProperty("mail.smtp.port"));
        // 设置发送邮箱
        props.put("mail.user", env.getProperty("mail.from.address"));
        // 设置发送邮箱的16位STMP口令
        props.put("mail.password", env.getProperty("mail.from.smtp.pwd"));
        ...
        // 设置发件人
        String nickName = MimeUtility.encodeText(env.getProperty("mail.from.nickname"));
